...
// 0x1000 - 0x10FF: Outputs(UNUSED)
// 0x1100 - 0x11FF: PWM(UNUSED)
...
// 0x1800 - 0x18FF: Starter Disable(UNUSED)
// 0x1900 - 0x19FF: Wipers(UNUSED)
// 0x2000 - 0x20FF: CAN Outputs
// 0X2100 - 0x21FF: Digital Outputs
// 0x2200 - 0x22FF: Analog Inputs
// 0x3000 - 0x30FF: Keypads(UNUSED)
// 0x3100 - 0x31FF: Keypad Buttons(UNUSED)
// 0x3200 - 0x32FF: Keypad Dials(UNUSED)
